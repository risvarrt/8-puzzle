var emptytilePosRow = parseInt(v[0]);
var emptytilePosCol = parseInt(v[2]);
var cellDisplacement = "69px";
		...
		function start() {
			...
			var init = new Node(0, [[arr[0],arr[1],arr[2]],[arr[3],arr[4],arr[5]],[arr[6],arr[7],arr[8]]],emptytilePosRow,  emptytilePosCol, 0)
